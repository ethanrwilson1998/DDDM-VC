...
def inference(a): 
    ...
    with torch.no_grad(): 
        c = model.vc(src_mel, w2v_x, f0_code, src_length, src_mel, src_length, n_timesteps=a.time_step, mode='ml', eps=a.epsilon, theta=a.theta)
...
def process_folder(audio_folder):
    ...
    for participant in participants:
        ...
        for clip in audio_clips:
            ...
            a.src_path = clip
            a.trg_path = clip  # Since we are processing per participant, keep trg_path same
...
def main():
    ...
    parser.add_argument('--ckpt_f0_vqvae', '-f', type=str, default='./f0_vqvae/f0_vqvae.pth')
